...
renderResponse.setTitle(title);
      ...
      _jspx_th_portlet_actionURL_0.setName( rootFolder ? "/journal/update_workflow_definitions" : ((folder == null) ? "/journal/add_folder" : "/journal/update_folder") );
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          if (_jspx_eval_liferay$1ui_error_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_liferay$1ui_message_0.setArguments( JournalFolderConstants.NAME_RESERVED_WORDS );
              _jspx_th_liferay$1ui_message_0.setKey("the-folder-name-cannot-be-blank-or-a-reserved-word-such-as-x");
              ...
              _jspx_th_liferay$1ui_message_1.setArguments( JournalFolderConstants.getNameInvalidCharacters(journalDisplayContext.getCharactersBlacklist()) );
              _jspx_th_liferay$1ui_message_1.setKey("the-folder-name-cannot-contain-the-following-invalid-characters-x");
 ...
 !rootFolder && (folder != null) ) {
            ...
            if (_jspx_eval_liferay$1frontend_fieldset_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              if (_jspx_eval_aui_script_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                ...
                do {
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\tvar selectFolderButton = document.getElementById(\n");
                  out.write("\t\t\t\t\t\t\t\t'");
                  ...
                  out.write("\t\t\t\t\t\t\t);\n");
                  out.write("\n");
                  out.write("\t\t\t\t\t\t\tselectFolderButton.addEventListener('click', (event) => {\n");
...
if (
 rootFolder || (folder != null) ) {
            ...
            out.write("\t\t\t\t");
            //  liferay-frontend:fieldset
            com.liferay.frontend.taglib.servlet.taglib.FieldsetTag _jspx_th_liferay$1frontend_fieldset_3 = (_jspx_resourceInjector != null) ? _jspx_resourceInjector.createTagHandlerInstance(com.liferay.frontend.taglib.servlet.taglib.FieldsetTag.class) : new com.liferay.frontend.taglib.servlet.taglib.FieldsetTag();
...
if (
 !rootFolder ) {
              ...
              _jspx_th_aui_input_6.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_3);
 ...
 workflowEnabled ) {
                    ...
                    if (_jspx_eval_liferay$1ui_search$1container$1column$1text_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                      ...
                      do {
                        ...
                        _jspx_th_aui_select_0.setWrapperCssClass("mb-0");
...
if (
 !rootFolder ) {
            ...
            if (_jspx_th_liferay$1frontend_fieldset_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
              if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1frontend_fieldset_3);
              _jspx_th_liferay$1frontend_fieldset_3.release();
              return;
            }
            if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1frontend_fieldset_3);
            _jspx_th_liferay$1frontend_fieldset_3.release();
...
if (
 !rootFolder && (folder == null) ) {
            ...
            out.write("\t\t\t\t");
            //  liferay-frontend:fieldset
            com.liferay.frontend.taglib.servlet.taglib.FieldsetTag _jspx_th_liferay$1frontend_fieldset_4 = (_jspx_resourceInjector != null) ? _jspx_resourceInjector.createTagHandlerInstance(com.liferay.frontend.taglib.servlet.taglib.FieldsetTag.class) : new com.liferay.frontend.taglib.servlet.taglib.FieldsetTag();
            ...
            if (_jspx_th_liferay$1frontend_fieldset_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
              if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1frontend_fieldset_4);
              _jspx_th_liferay$1frontend_fieldset_4.release();
              return;
            }
            if (_jspx_resourceInjector != null) _jspx_resourceInjector.preDestroy(_jspx_th_liferay$1frontend_fieldset_4);
            _jspx_th_liferay$1frontend_fieldset_4.release();
 ...
 workflowEnabled ) {
      ...
      if (_jspx_eval_aui_script_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t);\n");
          out.write("\n");
          out.write("\tvar selectDDMStructureButton = document.getElementById(\n");
          out.write("\t\t'");
          ...
          out.write("\t);\n");
          out.write("\n");
          out.write("\tif (selectDDMStructureButton) {\n");
          out.write("\t\tselectDDMStructureButton.addEventListener('click', (event) => {\n");
          out.write("\t\t\tLiferay.Util.openSelectionModal({\n");
          out.write("\t\t\t\tonSelect: function (selectedItem) {\n");
          out.write("\t\t\t\t\tconst itemValue = JSON.parse(selectedItem.value);\n");
          out.write("\n");
          out.write("\t\t\t\t\tvar ddmStructureLink =\n");
          out.write("\t\t\t\t\t\t'<a class=\"modify-link\" data-rowId=\"' +\n");
...
if (
 workflowEnabled ) {
          ...
          out.write("';\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\tworkflowDefinitions = workflowDefinitions.replace(\n");
          out.write("\t\t\t\t\t\t\t\t/LIFERAY_WORKFLOW_DEFINITION_DDM_STRUCTURE/g,\n");
          out.write("\t\t\t\t\t\t\t\t'workflowDefinition' + itemValue.ddmstructureid\n");
          out.write("\t\t\t\t\t\t\t);\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\tsearchContainer.addRow(\n");
          out.write("\t\t\t\t\t\t\t\t[itemValue.name, workflowDefinitions, ddmStructureLink],\n");
          out.write("\t\t\t\t\t\t\t\titemValue.ddmstructureid\n");
          out.write("\t\t\t\t\t\t\t);\n");
          out.write("\t\t\t\t\t\t");
          out.write("\n");
          ...
          out.write("\n");
          out.write("\t\t\t\t\t\t\tsearchContainer.addRow(\n");
          out.write("\t\t\t\t\t\t\t\t[itemValue.name, ddmStructureLink],\n");
          out.write("\t\t\t\t\t\t\t\titemValue.ddmstructureid\n");
          out.write("\t\t\t\t\t\t\t);\n");
          out.write("\t\t\t\t\t\t");
          out.write("\n");
