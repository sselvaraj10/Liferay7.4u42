...
public final class move_005farticles_005fand_005ffolders_jsp extends org.apache.jasper.runtime.HttpJspBase
...
JournalMoveEntriesDisplayContext journalMovesEntriesDisplayContext = new JournalMoveEntriesDisplayContext(liferayPortletRequest, liferayPortletResponse);
      ...
      _jspx_th_portlet_actionURL_0.setName("/journal/move_articles_and_folders");
      ...
      if (_jspx_eval_liferay$1frontend_edit$1form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        if (_jspx_eval_liferay$1frontend_edit$1form$1body_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          _jspx_th_liferay$1ui_error_2.setException( InvalidFolderException.class );
          ...
          _jspx_th_liferay$1ui_error_3.setException( NoSuchFolderException.class );
          _jspx_th_liferay$1ui_error_3.setMessage("please-enter-a-valid-folder");
...
if (
 !validMoveFolders.isEmpty() ) {
              ...
              out.write("\n");
              out.write("\n");
              out.write("\t\t\t\t\t\t\t<li class=\"move-folder\">\n");
              out.write("\t\t\t\t\t\t\t\t<span class=\"folder-title\">\n");
              out.write("\t\t\t\t\t\t\t\t\t");
...
if (
 !invalidMoveFolders.isEmpty() ) {
              ...
              out.write("\n");
              out.write("\n");
              out.write("\t\t\t\t\t\t\t<li class=\"icon-warning-sign move-error move-folder\">\n");
              out.write("\t\t\t\t\t\t\t\t<span class=\"folder-title\">\n");
              out.write("\t\t\t\t\t\t\t\t\t");
              out.print( HtmlUtil.escape(folder.getName()) );
              out.write("\n");
              ...
              out.write("\t\t\t\t\t\t\t\t\t");
              if (_jspx_meth_liferay$1ui_message_3((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1frontend_fieldset_0, _jspx_page_context))
                return;
              out.write("\n");
              out.write("\t\t\t\t\t\t\t\t</span>\n");
              out.write("\t\t\t\t\t\t\t</li>\n");
...
if (
 !validMoveArticles.isEmpty() ) {
              ...
              _jspx_th_liferay$1ui_message_4.setArguments( validMoveArticles.size() );
              _jspx_th_liferay$1ui_message_4.setKey("x-web-content-instances-are-ready-to-be-moved");
              ...
              out.write("\n");
              out.write("\n");
              out.write("\t\t\t\t\t\t\t<li class=\"move-article\">\n");
              out.write("\t\t\t\t\t\t\t\t<span class=\"article-title\" title=\"");
...
if (
 !invalidMoveArticles.isEmpty() ) {
              ...
              _jspx_th_liferay$1ui_message_5.setArguments( invalidMoveArticles.size() );
              _jspx_th_liferay$1ui_message_5.setKey("x-web-content-instances-cannot-be-moved");
              ...
              out.write("\n");
              out.write("\n");
              out.write("\t\t\t\t\t\t\t<li class=\"icon-warning-sign move-article move-error\">\n");
              out.write("\t\t\t\t\t\t\t\t<span class=\"article-title\" title=\"");
              ...
              out.write("\t\t\t\t\t\t\t\t<span class=\"error-message\">\n");
              out.write("\t\t\t\t\t\t\t\t\t");
              if (_jspx_meth_liferay$1ui_message_6((javax.servlet.jsp.tagext.JspTag) _jspx_th_liferay$1frontend_fieldset_0, _jspx_page_context))
                return;
              out.write("\n");
              out.write("\t\t\t\t\t\t\t\t</span>\n");
              out.write("\t\t\t\t\t\t\t</li>\n");
  ...
  private boolean _jspx_meth_liferay$1ui_message_3(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1frontend_fieldset_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_0);
    _jspx_th_liferay$1ui_message_3.setKey("you-do-not-have-the-required-permissions");
  ...
  private boolean _jspx_meth_liferay$1ui_message_6(javax.servlet.jsp.tagext.JspTag _jspx_th_liferay$1frontend_fieldset_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  liferay-ui:message
    ...
    _jspx_th_liferay$1ui_message_6.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_liferay$1frontend_fieldset_0);
    _jspx_th_liferay$1ui_message_6.setKey("you-do-not-have-the-required-permissions");
