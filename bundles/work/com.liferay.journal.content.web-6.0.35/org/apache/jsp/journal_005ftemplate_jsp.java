...
String refererPortletName = ParamUtil.getString(request, "refererPortletName");
	...
	if (defaultDDMTemplate != null) {
        ...
        _jspx_th_aui_input_0.setLabel( LanguageUtil.format(request, "use-default-template-x", defaultDDMTemplateName, false) );
        ...
        out.write("customDDMTemplateContainer\">\n");
...
if (
 journalContentDisplayContext.isDefaultTemplate() ) {
        ...
        _jspx_th_aui_button_1.setId( refererPortletName + "clearddmTemplateButton" );
        _jspx_th_aui_button_1.setUseNamespace( false );
      ...
      _jspx_th_liferay$1frontend_component_0.setComponentId("journalTemplate");
      _jspx_th_liferay$1frontend_component_0.setContext( journalContentDisplayContext.getJournalTemplateContext() );
      _jspx_th_liferay$1frontend_component_0.setModule("js/JournalTemplate");
  ...
  private boolean _jspx_meth_liferay$1ui_message_2(javax.servlet.jsp.tagext.JspTag _jspx_th_clay_sheet$1section_0, PageContext _jspx_page_context)
    ...
    _jspx_th_liferay$1ui_message_2.setKey("no-template");
