...
import com.liferay.user.model.UserModel;
import com.liferay.user.service.UserLocalServiceUtil;
...
/**
 * The base model implementation for the User service. Represents a row in the &quot;UserDetails_User&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class UserModelImpl extends BaseModelImpl<User> implements UserModel {
	 ...
	 */
	public static final String TABLE_NAME = "UserDetails_User";

	public static final Object[][] TABLE_COLUMNS = {
		{"uuid_", Types.VARCHAR}, {"usId", Types.BIGINT},
		{"groupId", Types.BIGINT}, {"companyId", Types.BIGINT},
		{"userId", Types.BIGINT}, {"userName", Types.VARCHAR},
		{"createDate", Types.TIMESTAMP}, {"modifiedDate", Types.TIMESTAMP},
		{"name", Types.VARCHAR}, {"language", Types.VARCHAR}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("usId", Types.BIGINT);
	...
	public static final String TABLE_SQL_CREATE =
		"create table UserDetails_User (uuid_ VARCHAR(75) null,usId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,language VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table UserDetails_User";

	public static final String ORDER_BY_JPQL = " ORDER BY user.usId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY UserDetails_User.usId ASC";
	 ...
	 */
	@Deprecated
	public static final long USID_COLUMN_BITMASK = 8L;
	...
	static {
		...
		attributeGetterFunctions.put("usId", User::getUsId);
		attributeSetterBiConsumers.put(
			"usId", (BiConsumer<User, Long>)User::setUsId);
		...
		attributeGetterFunctions.put("name", User::getName);
		attributeSetterBiConsumers.put(
			"name", (BiConsumer<User, String>)User::setName);
		attributeGetterFunctions.put("language", User::getLanguage);
		attributeSetterBiConsumers.put(
			"language", (BiConsumer<User, String>)User::setLanguage);
	...
	public Object clone() {
		...
		userImpl.setLanguage(getLanguage());
	...
	public User cloneWithOriginalValues() {
		...
		userImpl.setUsId(this.<Long>getColumnOriginalValue("usId"));
		...
		userImpl.setName(this.<String>getColumnOriginalValue("name"));
		userImpl.setLanguage(this.<String>getColumnOriginalValue("language"));
	...
	public CacheModel<User> toCacheModel() {
		...
		userCacheModel.name = getName();

		String name = userCacheModel.name;

		if ((name != null) && (name.length() == 0)) {
			userCacheModel.name = null;
		}

		userCacheModel.language = getLanguage();

		String language = userCacheModel.language;

		if ((language != null) && (language.length() == 0)) {
			userCacheModel.language = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("usId", _usId);
	...
	static {
		...
		columnBitmasks.put("language", 512L);
