...
import com.liferay.user.model.UserTable;
import com.liferay.user.model.impl.UserImpl;
import com.liferay.user.model.impl.UserModelImpl;
...
@Component(
	immediate = true,
	service = {UserModelArgumentsResolver.class, ArgumentsResolver.class}
)
