package liferay.headless.apps.resource.v1_0.test;
...
import liferay.headless.apps.client.resource.v1_0.AppResource;
...
public abstract class BaseAppResourceTestCase {
	...
	public void testPostApp() throws Exception {
		...
		App postApp = testPostApp_addApp(randomApp);

		assertEquals(randomApp, postApp);
		assertValid(postApp);
	}

	protected App testPostApp_addApp(App app) throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(liferay.headless.apps.dto.v1_0.App.class)) {
	...
	@Inject
	private liferay.headless.apps.resource.v1_0.AppResource _appResource;
