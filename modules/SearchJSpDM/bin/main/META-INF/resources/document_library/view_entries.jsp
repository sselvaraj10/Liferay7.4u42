...
<%
	System.out.println("view entries page");
...
DLViewEntriesDisplayContext dlViewEntriesDisplayContext = new DLViewEntriesDisplayContext(liferayPortletRequest, liferayPortletResponse);
	SearchContainer ent = dlViewEntriesDisplayContext.getSearchContainer();
	for (int i = 0; i < ent.getResults().size(); i++) {
		System.out.println("view entries result: "+ent.getResults().get(i));
	}
%>
