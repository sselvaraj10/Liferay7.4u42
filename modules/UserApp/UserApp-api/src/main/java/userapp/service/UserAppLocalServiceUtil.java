...
/**
 * Provides the local service utility for UserApp. This utility wraps
 * <code>userapp.service.impl.UserAppLocalServiceImpl</code> and
 ...
 * @generated
 */
public class UserAppLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>userapp.service.impl.UserAppLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static UserApp addUserApp(UserApp userApp) {
		return getService().addUserApp(userApp);
	}
	 ...
	 */
	public static UserApp createUserApp(String appId) {
		return getService().createUserApp(appId);
	}
	 ...
	 */
	public static UserApp deleteUserApp(String appId) throws PortalException {
		return getService().deleteUserApp(appId);
	}
	 ...
	 * @return the user app that was removed
	 */
	public static UserApp deleteUserApp(UserApp userApp) {
		return getService().deleteUserApp(userApp);
	}
	...
	public static UserApp fetchUserApp(String appId) {
		return getService().fetchUserApp(appId);
	}
	 ...
	 * @throws PortalException if a user app with the primary key could not be found
	 */
	public static UserApp getUserApp(String appId) throws PortalException {
		return getService().getUserApp(appId);
	}
	 ...
	 */
	public static List<UserApp> getUserApps(int start, int end) {
		return getService().getUserApps(start, end);
	}
	 ...
	 */
	public static int getUserAppsCount() {
		return getService().getUserAppsCount();
	}
	 ...
	 */
	public static UserApp updateUserApp(UserApp userApp) {
		return getService().updateUserApp(userApp);
	}

	public static UserAppLocalService getService() {
		return _service;
	}

	private static volatile UserAppLocalService _service;
