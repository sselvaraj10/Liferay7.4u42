...
import moduleblacklistservice.model.PortletModel;

/**
 * The base model implementation for the Portlet service. Represents a row in the &quot;ModuleBlaclist_Portlet&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PortletModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "ModuleBlaclist_Portlet";
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"portletId", Types.VARCHAR}, {"active_", Types.BOOLEAN}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table ModuleBlaclist_Portlet (uuid_ VARCHAR(75) null,id_ LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,portletId VARCHAR(75) null,active_ BOOLEAN)";

	public static final String TABLE_SQL_DROP =
		"drop table ModuleBlaclist_Portlet";

	public static final String ORDER_BY_JPQL = " ORDER BY portlet.id ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY ModuleBlaclist_Portlet.id_ ASC";
	...
	static {
		...
		attributeGetterFunctions.put("uuid", Portlet::getUuid);
		attributeSetterBiConsumers.put(
			"uuid", (BiConsumer<Portlet, String>)Portlet::setUuid);
		attributeGetterFunctions.put("id", Portlet::getId);
		attributeSetterBiConsumers.put(
			"id", (BiConsumer<Portlet, Long>)Portlet::setId);
		attributeGetterFunctions.put("groupId", Portlet::getGroupId);
		attributeSetterBiConsumers.put(
			"groupId", (BiConsumer<Portlet, Long>)Portlet::setGroupId);
		attributeGetterFunctions.put("companyId", Portlet::getCompanyId);
		attributeSetterBiConsumers.put(
			"companyId", (BiConsumer<Portlet, Long>)Portlet::setCompanyId);
		attributeGetterFunctions.put("userId", Portlet::getUserId);
		attributeSetterBiConsumers.put(
			"userId", (BiConsumer<Portlet, Long>)Portlet::setUserId);
		attributeGetterFunctions.put("userName", Portlet::getUserName);
		attributeSetterBiConsumers.put(
			"userName", (BiConsumer<Portlet, String>)Portlet::setUserName);
		attributeGetterFunctions.put("createDate", Portlet::getCreateDate);
		attributeSetterBiConsumers.put(
			"createDate", (BiConsumer<Portlet, Date>)Portlet::setCreateDate);
		attributeGetterFunctions.put("modifiedDate", Portlet::getModifiedDate);
		attributeSetterBiConsumers.put(
			"modifiedDate",
			(BiConsumer<Portlet, Date>)Portlet::setModifiedDate);
	...
	public Object clone() {
		...
		portletImpl.setUuid(getUuid());
		portletImpl.setId(getId());
		portletImpl.setGroupId(getGroupId());
		portletImpl.setCompanyId(getCompanyId());
		portletImpl.setUserId(getUserId());
		portletImpl.setUserName(getUserName());
		portletImpl.setCreateDate(getCreateDate());
		portletImpl.setModifiedDate(getModifiedDate());
	...
	public Portlet cloneWithOriginalValues() {
		...
		portletImpl.setUuid(this.<String>getColumnOriginalValue("uuid_"));
		portletImpl.setId(this.<Long>getColumnOriginalValue("id_"));
		portletImpl.setGroupId(this.<Long>getColumnOriginalValue("groupId"));
		portletImpl.setCompanyId(
			this.<Long>getColumnOriginalValue("companyId"));
		portletImpl.setUserId(this.<Long>getColumnOriginalValue("userId"));
		portletImpl.setUserName(
			this.<String>getColumnOriginalValue("userName"));
		portletImpl.setCreateDate(
			this.<Date>getColumnOriginalValue("createDate"));
		portletImpl.setModifiedDate(
	...
	public CacheModel<Portlet> toCacheModel() {
		...
		portletCacheModel.uuid = getUuid();

		String uuid = portletCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			portletCacheModel.uuid = null;
		}

		portletCacheModel.id = getId();

		portletCacheModel.groupId = getGroupId();

		portletCacheModel.companyId = getCompanyId();

		portletCacheModel.userId = getUserId();

		portletCacheModel.userName = getUserName();

		String userName = portletCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			portletCacheModel.userName = null;
		}

		Date createDate = getCreateDate();

		if (createDate != null) {
			portletCacheModel.createDate = createDate.getTime();
		}
		else {
			portletCacheModel.createDate = Long.MIN_VALUE;
		}

		Date modifiedDate = getModifiedDate();

		if (modifiedDate != null) {
			portletCacheModel.modifiedDate = modifiedDate.getTime();
		}
		else {
			portletCacheModel.modifiedDate = Long.MIN_VALUE;
		}
