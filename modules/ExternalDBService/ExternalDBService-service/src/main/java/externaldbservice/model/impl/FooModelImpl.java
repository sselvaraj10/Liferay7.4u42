...
import externaldbservice.model.FooModel;
...
/**
 * The base model implementation for the Foo service. Represents a row in the &quot;ExternalDB_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	 ...
	 */
	public static final String TABLE_NAME = "ExternalDB_Foo";
	...
	public static final String TABLE_SQL_CREATE =
		"create table ExternalDB_Foo (uuid_ VARCHAR(75) null,fooId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,eid INTEGER)";

	public static final String TABLE_SQL_DROP = "drop table ExternalDB_Foo";

	public static final String ORDER_BY_JPQL = " ORDER BY foo.fooId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY ExternalDB_Foo.fooId ASC";
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(
		externaldbservice.service.util.ServiceProps.get(
			"lock.expiration.time.externaldbservice.model.Foo"));
	...
	static {
		...
		attributeGetterFunctions.put("eid", Foo::getEid);
		attributeSetterBiConsumers.put(
			"eid", (BiConsumer<Foo, Integer>)Foo::setEid);
	...
	public Foo cloneWithOriginalValues() {
		...
		fooImpl.setEid(this.<Integer>getColumnOriginalValue("eid"));
