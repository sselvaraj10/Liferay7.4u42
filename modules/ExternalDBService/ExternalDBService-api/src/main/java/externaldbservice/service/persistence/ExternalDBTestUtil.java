...
/**
 * The persistence utility for the external db test service. This utility wraps <code>externaldbservice.service.persistence.impl.ExternalDBTestPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see ExternalDBTestPersistence
 * @generated
 */
public class ExternalDBTestUtil {
	 ...
	 */
	public static void clearCache(ExternalDBTest externalDBTest) {
		getPersistence().clearCache(externalDBTest);
	}
	 ...
	 */
	public static Map<Serializable, ExternalDBTest> fetchByPrimaryKeys(
	 ...
	 */
	public static List<ExternalDBTest> findWithDynamicQuery(
	 ...
	 */
	public static ExternalDBTest update(ExternalDBTest externalDBTest) {
		return getPersistence().update(externalDBTest);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static ExternalDBTest update(
		ExternalDBTest externalDBTest, ServiceContext serviceContext) {

		return getPersistence().update(externalDBTest, serviceContext);
	}
	 ...
	 */
	public static List<ExternalDBTest> findByUuid(String uuid) {
	 ...
	 */
	public static List<ExternalDBTest> findByUuid(
	 ...
	 */
	public static ExternalDBTest findByUuid_First(
			String uuid, OrderByComparator<ExternalDBTest> orderByComparator)
		throws externaldbservice.exception.NoSuchTestException {
	 ...
	 */
	public static ExternalDBTest fetchByUuid_First(
		String uuid, OrderByComparator<ExternalDBTest> orderByComparator) {
	 ...
	 * @throws NoSuchTestException if a matching external db test could not be found
	 */
	public static ExternalDBTest findByUuid_Last(
			String uuid, OrderByComparator<ExternalDBTest> orderByComparator)
		throws externaldbservice.exception.NoSuchTestException {
	 ...
	 */
	public static ExternalDBTest fetchByUuid_Last(
		String uuid, OrderByComparator<ExternalDBTest> orderByComparator) {
	 ...
	 */
	public static ExternalDBTest[] findByUuid_PrevAndNext(
	 ...
	 * @throws NoSuchTestException if a matching external db test could not be found
	 */
	public static ExternalDBTest findByUUID_G(String uuid, long groupId)
		throws externaldbservice.exception.NoSuchTestException {
	 ...
	 */
	public static ExternalDBTest fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching external db test, or <code>null</code> if a matching external db test could not be found
	 */
	public static ExternalDBTest fetchByUUID_G(
	 ...
	 */
	public static ExternalDBTest removeByUUID_G(String uuid, long groupId)
		throws externaldbservice.exception.NoSuchTestException {
	 ...
	 * @return the matching external db tests
	 */
	public static List<ExternalDBTest> findByUuid_C(
	 ...
	 * @throws NoSuchTestException if a matching external db test could not be found
	 */
	public static ExternalDBTest findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<ExternalDBTest> orderByComparator)
		throws externaldbservice.exception.NoSuchTestException {
	 ...
	 * @return the first matching external db test, or <code>null</code> if a matching external db test could not be found
	 */
	public static ExternalDBTest fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<ExternalDBTest> orderByComparator) {
	 ...
	 * @throws NoSuchTestException if a matching external db test could not be found
	 */
	public static ExternalDBTest findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<ExternalDBTest> orderByComparator)
		throws externaldbservice.exception.NoSuchTestException {
	 ...
	 * @return the last matching external db test, or <code>null</code> if a matching external db test could not be found
	 */
	public static ExternalDBTest fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<ExternalDBTest> orderByComparator) {
	 ...
	 * @throws NoSuchTestException if a external db test with the primary key could not be found
	 */
	public static ExternalDBTest[] findByUuid_C_PrevAndNext(
	 ...
	 */
	public static void cacheResult(ExternalDBTest externalDBTest) {
		getPersistence().cacheResult(externalDBTest);
	}
	 ...
	 */
	public static void cacheResult(List<ExternalDBTest> externalDBTests) {
		getPersistence().cacheResult(externalDBTests);
	}
	 ...
	 */
	public static ExternalDBTest create(long fooId) {
	 ...
	 * @throws NoSuchTestException if a external db test with the primary key could not be found
	 */
	public static ExternalDBTest remove(long fooId)
		throws externaldbservice.exception.NoSuchTestException {

		return getPersistence().remove(fooId);
	}

	public static ExternalDBTest updateImpl(ExternalDBTest externalDBTest) {
		return getPersistence().updateImpl(externalDBTest);
	}
	 ...
	 * @throws NoSuchTestException if a external db test with the primary key could not be found
	 */
	public static ExternalDBTest findByPrimaryKey(long fooId)
		throws externaldbservice.exception.NoSuchTestException {
	 ...
	 */
	public static ExternalDBTest fetchByPrimaryKey(long fooId) {
	 ...
	 */
	public static List<ExternalDBTest> findAll() {
	 ...
	 */
	public static List<ExternalDBTest> findAll(int start, int end) {
	...
	public static ExternalDBTestPersistence getPersistence() {
		return _persistence;
	}

	private static volatile ExternalDBTestPersistence _persistence;
