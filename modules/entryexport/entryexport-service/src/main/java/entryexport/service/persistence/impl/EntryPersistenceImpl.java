...
package entryexport.service.persistence.impl;
...
import entryexport.exception.NoSuchEntryException;

import entryexport.model.Entry;
import entryexport.model.EntryTable;
import entryexport.model.impl.EntryImpl;
import entryexport.model.impl.EntryModelImpl;

import entryexport.service.persistence.EntryPersistence;
import entryexport.service.persistence.EntryUtil;
import entryexport.service.persistence.impl.constants.EXPersistenceConstants;
...
public class EntryPersistenceImpl
	...
	@Override
	@Reference(
		target = EXPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = EXPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
