...
<#assign portletLocalService = serviceLocator.findService("moduleblacklistservice.service.PortletLocalService") />
<#assign listofPortlets = portletLocalService.getPortletByGroupId(theme_display.getSiteGroupId())/>
